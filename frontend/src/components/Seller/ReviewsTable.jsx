...
import { clearErrors, deleteReview, getAllVendorReviews } from '../../actions/productAction';
...
const ReviewsTable = () => {
    ...
    useEffect(() => {
        if (productId.length === 24) {
            console.log("product id is visible", productId)
            dispatch(getAllVendorReviews(productId));
        }
        if (error) {
    ...
    return (
        <>
            <MetaData title="Admin Reviews | Shopzy" />
