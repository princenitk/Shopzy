...
import { clearErrors, getProductDetails, updateVendorProduct } from '../../actions/productAction';
...
const UpdateProduct = () => {
    ...
    const newProductSubmitHandler = (e) => {
        ...
        dispatch(updateVendorProduct(params.id, formData));
    }
    ...
    return (
        <>
            <MetaData title=" Vendor: Update Product | Shopzy" />
