import {
    ...
    VENDOR_NEW_PRODUCT_REQUEST,
    VENDOR_NEW_PRODUCT_SUCCESS,
    VENDOR_NEW_PRODUCT_FAIL,
    VENDOR_NEW_PRODUCT_RESET,
...
export const productsReducer = (state = { products: [] }, { type, payload }) => {
    switch (type) {
        ...
        case VENDOR_PRODUCTS_REQUEST: // added vendor products request
            return {
                loading: true,
                products: [],
            };
        ...
        case VENDOR_PRODUCTS_SUCCESS: // added vendor products success
            return {
                loading: false,
                products: payload,
            };
        ...
        case VENDOR_PRODUCTS_FAIL: // added vendor products fail
            return {
                loading: false,
                error: payload,
            };
...
export const newProductReducer = (state = { product: {} }, { type, payload }) => {
    switch (type) {
        ...
        case VENDOR_NEW_PRODUCT_REQUEST: // added vendor new product request
            return {
                ...state,
                loading: true,
            };
        case NEW_PRODUCT_SUCCESS:
        case VENDOR_NEW_PRODUCT_SUCCESS: // added vendor new product success
            return {
                loading: false,
        ...
        case VENDOR_NEW_PRODUCT_FAIL: // added vendor new product fail
            return {
                ...state,
                loading: false,
                error: payload,
        ...
        case VENDOR_NEW_PRODUCT_RESET: // added vendor new product reset
            return {
                ...state,
                success: false,
            };
